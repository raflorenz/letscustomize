...
| Part | Material names |
|---|---|
| Front Fairing | `paint_front`, `<auto>8`, `paint_fender` (front fender, split from `<auto>` by `scripts/split-adv150-fender.mjs`) |
